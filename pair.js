        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "ASiM-MD~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *ASiM_MD Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by ASiM_MDn\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/muhammadasim4481-alk/ASiM-MD\n` +
                            `▸ https://whatsapp.com/channel/0029Vb6Rp8V4IBh5NOFuet2B`,
                        contextInfo: {
